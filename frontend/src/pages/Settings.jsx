...
const Settings = () => {
  ...
  const fetchUserData = async () => {
    try {
      ...
      if (userPrefs) {
        setPreferences({
          dietary_restriction: userPrefs.dietary_restriction || [],
  ...
  const toggleDietary = (option) => {
    setPreferences((prev) => ({
      ...prev,
      dietary_restriction: prev.dietary_restriction.includes(option)
        ? prev.dietary_restriction.filter((d) => d !== option)
        : [...prev.dietary_restriction, option],
    }));
  };
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-6">
            ...
            <form onSubmit={handleProfileUpdate} className="space-y-4">
              ...
              <button
                type="submit"
                disabled={saving}
                className="flex items-center gap-2 bg-purple-500 hover:bg-purple-600 text-white px-4 py-2 rounded-lg font-medium transition-colors disabled:opacity-50"
              >
                  ...
                  {DIETARY_OPTIONS.map((option) => (
                    <button
                      ...
                      className={`px-3 py-1.5 rounded-lg text-sm font-medium transition-colors ${
                        preferences.dietary_restriction.includes(option)
