...
const RecipeDetail = () => {
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      toast.error("Failed to deleted recipe");
    }
  };
          ...
          <div className="lg:col-span-2 space-y-6">
                ...
                {recipe.instructions &&
                  recipe.instructions.map((step, index) => (
                    <li key={index} className="flex gap-4">
                      <span className="shrink-0 w-8 h-8 bg-purple-500 text-white rounded-full flex items-center justify-center text-sm font-semibold">
                        {index + 1}
                      </span>
            ...
            {recipe.user_notes && (
              <div className="bg-purple-50 rounded-xl border border-purple-200 p-6">
                <h3 className="font-semibold text-purple-900 mb-2">📝 Notes</h3>
                <p className="text-purple-800">{recipe.user_notes}</p>
              </div>
            )}
          </div>
        </div>
