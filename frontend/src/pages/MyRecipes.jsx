        ...
        {filteredRecipes.length > 0 ? (
          ...
          <div className="bg-white rounded-lg border border-gray-200 p-12 text-center">
            ...
            {recipes.length === 0 && (
              <Link
                to="/generate"
                className="inline-block bg-purple-500 hover:bg-purple-600 text-white px-6 py-2.5 rounded-lg font-medium transition-colors"
              >
...
const RecipeCard = ({ recipe, onDelete }) => {
  ...
  return (
    <div className="bg-white rounded-xl border border-gray-200 overflow-hidden hover:shadow-lg transition-all group">
      ...
      <div className="h-48 bg-linear-to-br from-purple-100 to-purple-200 flex items-center justify-center">
      ...
      <div className="p-5">
        ...
        <div className="flex gap-2 pt-4 border-t border-gray-100">
          <Link
            ...
            className="flex-1 bg-purple-500 hover:bg-purple-600 text-white text-center py-2 rounded-lg font-medium transition-colors text-sm"
          >
            View Recipe
          </Link>
          <button
